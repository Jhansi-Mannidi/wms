...
// Sourced from the shared client universe in `lib/mock-data.ts` — every screen that shows a
// client's SKU count, dues, or open orders reads from that same module, so this directory
// always agrees with Portal Home, Billing, and every other screen that mentions a client.
const initialClients: Client[] = CLIENTS
