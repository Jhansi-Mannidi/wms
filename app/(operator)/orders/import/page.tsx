...
const initialLogs: ImportLog[] = [
  ...
  { file: "marketplace_orders_20240718.csv", rows: 41, success: 37, errors: 4, time: "2024-07-18 09:30", status: "Completed with errors" },
  { file: "b2b_priority_20240717.csv", rows: 18, success: 18, errors: 0, time: "2024-07-17 16:45", status: "Completed" },
  { file: "orders_batch_20240717.csv", rows: 56, success: 54, errors: 2, time: "2024-07-17 08:50", status: "Completed with errors" },
  { file: "orders_batch_20240716.csv", rows: 63, success: 63, errors: 0, time: "2024-07-16 09:05", status: "Completed" },
  { file: "marketplace_orders_20240716.csv", rows: 35, success: 35, errors: 0, time: "2024-07-16 07:40", status: "Completed" },
  { file: "b2b_weekly_20240715.csv", rows: 92, success: 85, errors: 7, time: "2024-07-15 18:20", status: "Completed with errors" },
  { file: "orders_batch_20240715.csv", rows: 47, success: 47, errors: 0, time: "2024-07-15 09:12", status: "Completed" },
  { file: "orders_returns_20240714.csv", rows: 12, success: 12, errors: 0, time: "2024-07-14 15:35", status: "Completed" },
  { file: "orders_batch_20240714.csv", rows: 58, success: 55, errors: 3, time: "2024-07-14 08:48", status: "Completed with errors" },
  { file: "marketplace_orders_20240713.csv", rows: 29, success: 29, errors: 0, time: "2024-07-13 10:25", status: "Completed" },
  { file: "orders_batch_20240713.csv", rows: 44, success: 44, errors: 0, time: "2024-07-13 08:30", status: "Completed" },
  { file: "b2b_priority_20240712.csv", rows: 21, success: 20, errors: 1, time: "2024-07-12 17:10", status: "Completed with errors" },
  { file: "orders_batch_20240712.csv", rows: 51, success: 51, errors: 0, time: "2024-07-12 09:00", status: "Completed" },
  { file: "orders_batch_20240711.csv", rows: 38, success: 38, errors: 0, time: "2024-07-11 08:55", status: "Completed" },
  { file: "marketplace_orders_20240711.csv", rows: 33, success: 31, errors: 2, time: "2024-07-11 07:20", status: "Completed with errors" },
  { file: "orders_bulk_20240710.csv", rows: 118, success: 118, errors: 0, time: "2024-07-10 19:40", status: "Completed" },
  { file: "orders_batch_20240710.csv", rows: 49, success: 49, errors: 0, time: "2024-07-10 09:08", status: "Completed" },
  { file: "b2b_weekly_20240709.csv", rows: 87, success: 82, errors: 5, time: "2024-07-09 18:00", status: "Completed with errors" },
  { file: "orders_batch_20240709.csv", rows: 42, success: 42, errors: 0, time: "2024-07-09 08:42", status: "Completed" },
]
