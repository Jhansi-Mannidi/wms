...
export default function PortalTrackingPage() {
  ...
  return (
    <div className="p-6 space-y-6 w-full">
      ...
      {/* Search bar */}
      <div className="flex items-center gap-2 px-4 py-3 rounded-xl border border-border bg-card max-w-md">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
          ...
          {filtered.map(s => (
            ...
            >
              <div className="flex items-start justify-between gap-2 mb-2">
                <div>
                  <p className="text-sm font-bold text-foreground">{s.id}</p>
              ...
              <p className="text-xs text-foreground/80 flex items-center gap-1"><MapPin className="w-3 h-3 text-muted-foreground" />{s.dest}</p>
        ...
        <div className="lg:col-span-3 rounded-xl border border-border bg-card overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-border">
            <div>
              <p className="text-sm font-bold text-foreground">{selected.id} — Tracking Timeline</p>
          ...
          <div className="flex items-center justify-between px-5 py-3 bg-brand/5 border-b border-border">
            <div className="flex items-center gap-2">
              ...
              <p className="text-xs font-semibold text-foreground">Estimated Delivery: <span className="text-brand">{selected.eta}</span></p>
            </div>
            {selected.awb !== "-" && (
              ...
              <div className="space-y-5">
                {selected.events.map((ev, i) => (
                  <div key={i} className="flex gap-4 relative">
                    <div className={cn(
                      "w-7 h-7 rounded-full border-2 flex items-center justify-center shrink-0 z-10 bg-card",
                      ev.done
                    ...
                    <div className="flex-1 pb-2">
                      <p className={cn("text-sm font-semibold", ev.done ? "text-foreground" : "text-muted-foreground")}>{ev.event}</p>
