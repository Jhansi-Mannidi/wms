                  ...
                  {zones.map((zone, i) => (
                    <tr key={zone.id} className={cn("border-b border-border/50 last:border-0 hover:bg-muted/30 transition-colors", i % 2 === 1 ? "bg-muted/10" : "")}>
                      ...
                      <td className="px-4 py-3">
                        <RowActions
                          items={[
                            { label: "Edit zone", icon: <Edit2 />, onSelect: () => openZoneEdit(zone) },
                            { label: "Delete zone", icon: <Trash2 />, onSelect: () => setDeleteZone(zone), tone: "danger" as const },
                          ]}
                        />
                      </td>
                    </tr>
                  ...
                  {docks.map((dock, i) => (
                    <tr key={dock.id} className={cn("border-b border-border/50 last:border-0 hover:bg-muted/30 transition-colors", i % 2 === 1 ? "bg-muted/10" : "")}>
                      ...
                      <td className="px-4 py-3">
                        <RowActions
                          items={[
                            { label: "Edit dock", icon: <Edit2 />, onSelect: () => openDockEdit(dock) },
                            { label: "Delete dock", icon: <Trash2 />, onSelect: () => setDeleteDock(dock), tone: "danger" as const },
                          ]}
                        />
                      </td>
                    </tr>
