              ...
              <tr key={a.id} className="hover:bg-muted/30 transition-colors">
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-1">
                    <button onClick={() => setDetail(a)} title="View details" className="p-1.5 rounded-md text-muted-foreground hover:bg-muted hover:text-foreground transition-colors">
                      <Eye className="w-3.5 h-3.5" />
                    </button>
                    {a.status === "Pending" && (
                      <>
                        <button onClick={() => approveAdjustment(a)} title="Approve adjustment" className="p-1.5 rounded-md text-success hover:bg-success/10 transition-colors">
                          <Check className="w-3.5 h-3.5" />
                        </button>
                        <button onClick={() => openEdit(a)} title="Edit adjustment" className="p-1.5 rounded-md text-muted-foreground hover:bg-muted hover:text-foreground transition-colors">
                          <Pencil className="w-3.5 h-3.5" />
                        </button>
                      </>
                    )}
                    <button onClick={() => setDeleteTarget(a)} title="Delete adjustment" className="p-1.5 rounded-md text-danger hover:bg-danger/10 transition-colors">
