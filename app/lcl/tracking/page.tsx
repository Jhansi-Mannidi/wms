...
import { Search, Package, ArrowRight, Download, CheckCircle2, Clock, Truck, Ship, MapPin } from "lucide-react"
...
export default function LCLTrackingPage() {
  ...
  const [selected, setSelected] = useState<string | null>(shipments[0].ref)
